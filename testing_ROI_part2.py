...
test_labels = pd.read_csv('abcdnp_testing_template_part2.csv', index_col=0)
...
## Save the output
saveOutput_string='out2.to_csv("pred_validation/20190324_pred_testset_ROI{}'.format(sys.argv[2]) + '_epoch' + sys.argv[3] + '_part2.csv")'
